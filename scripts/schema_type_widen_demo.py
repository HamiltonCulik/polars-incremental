...
Scenario: stored schema expects Int64, incoming data switches to Float64 or String.
"""
...
base = Path("data/type_widen_demo")
raw_dir = base / "raw"
...
# Process batch 1 (type widening happens here)
pipeline.run(once=True)

print("batch_0 schema:", pl.read_parquet(out_dir / "batch_0.parquet").schema)
print("batch_1 schema:", pl.read_parquet(out_dir / "batch_1.parquet").schema)
